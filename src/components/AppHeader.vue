...
<template>
  <header>
    <div class="container">
      <div
        class="d-flex header__inner flex-wrap flex-lg-nowrap align-items-center justify-content-between"
      >
        <div class="menu">
          <svg
              ...
              <ul class="category-menu" ref="menu">
                ...
                >
                  ...
                  <ul
                    ...
                    :class="{ 'dropdown-lvl-1_active': activeEl == key+1 }"
                  >
                    <li class="dropdown-lvl-1__title">
                      <router-link @click.stop="isActiveMenu=false;activeEl=0" :to="'/catalog/category/'+category.id">{{category.name }}</router-link>
                    </li>
                    <!-- <li class="dropdown-lvl-1__title">
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    fill="#223263"
                    mask="url(#path-1-inside-1_1_899)"
                  />
                  <path
            ...
            <li>
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M1.11035 1.11133H3.33257L5.5548 14.4447H16.6659L18.8881 4.44466H4.44369"
                    stroke="#223263"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
